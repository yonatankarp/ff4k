...
class PropertyLocalDateTest : PropertyContractTest<LocalDate, PropertyLocalDate>() {
    ...
    override fun otherValueNotInFixedValues(): LocalDate = LocalDate.parse("2024-12-31")

    override fun fixedValuesIncludingSample(sample: LocalDate): Set<LocalDate> = setOf(
