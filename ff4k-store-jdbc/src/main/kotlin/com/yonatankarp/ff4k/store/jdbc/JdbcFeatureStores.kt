...
): FeatureStore = jdbcFeatureStore(dataSource, detectDialect(dataSource), customSerializersModule, ioDispatcher)
...
private fun detectDialect(dataSource: DataSource): SqlDialect =
    dataSource.connection.use { conn ->
        val productName = conn.metaData.databaseProductName.lowercase(Locale.ROOT)
        when {
